...
```{r graphs actual, fig.width=10, fig.width=10, fig.align='center'}
...
```{r graphs simple, fig.width=10, fig.width=10, fig.align='center'}
...
```{r original pairs plot, fig.width=20, fig.height= 20, fig.align='center'}
...
```{r alternative pairs plot, fig.width=20, fig.height= 20, fig.align='center'}
...
```{r raw, fig.width=10, fig.width=10, fig.align='center'}
...
```{r y transformed, fig.width=10, fig.width=10, fig.align='center'}
dt$daily1 <- log(dt$daily1)
...
```{r final transformed, fig.width=10, fig.width=10, fig.align='center'}
...
```{r, fig.width=10, fig.width=10, fig.align='center'}
...
```{r alternative model, fig.align='center', fig.width=13.5}
...
```{r popularity segregation, fig.align='center'}
...
```{r lms summary, fig.width=10, fig.width=10, fig.align='center'}
...
```{r alternative diagnostic, fig.width=10, fig.width=10, fig.align='center'}
par(mfrow=c(1,3))
...
```{r original diagnostic, fig.width=10, fig.width=10, fig.align='center'}
par(mfrow=c(1,3))
plot(mylm,which=1:2)
plot(mylm$residuals)
```
...
```{r pred 1 graph, fig.align='center', fig.width=10}
...
We can say that the slope of this line is of **`r exp(b[3])`**, this means that for every follower gained in a month, we can expect around 2 additional streams. And, to be 95% certain that this prediction is accurate, the prediction interval is added. This means that we are 95% sure that for every new follower, the artist will have between 5 and 8 extra streams.
